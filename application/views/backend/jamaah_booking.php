...
<?php if ($site_form=="list") { ?>
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title"><h5>Booking Paket</h5></div>
                        <div class="ibox-content">
                            <div class="row">
								<div class="col-sm-7">
								<a href="<?php echo site_url("jamaah/booking/new"); ?>" class="btn btn-sm btn-primary"> Tambah </a>
								</div>
                                <div class="col-sm-5">
                                    <form method="post" action="<?php echo site_url("jamaah/booking/filter"); ?>">
                                    <div class="input-group"><input type="text" name="search" placeholder="Cari Kode Booking/Nama/No Telp" class="input-sm form-control"> <span class="input-group-btn">
                                    ...
                                    <?php 
                                        if (sizeof($data_booking)>0) {
                                            for ($i=0;$i<sizeof($data_booking);$i++) {
                                                ...
                                                $channel = $data_booking[$i]["channel_type"];
                                                ...
                                                echo "<td>$channel</td>";
                                                echo "<td>$kode</td>"; 
                                                echo "<td>$nama<br>$telepon<br>$email</td>";
                                                echo "<td>$namapaket $tgl_berangkat</td>";
                                                echo "<td>$jumlah</td>";
                                                echo "<td>$status</td>";
                            ...
                            <div class="row">
								...
								<?php if ($jmlpage>1) { ?>  	
									<div class="dataTables_paginate paging_simple_numbers" id="datatable_paginate">
										<ul class="pagination">
											<li class="paginate_button previous" aria-controls="datatable" tabindex="0" id="datatable_previous"><a href="<?php echo site_url("jamaah/booking/1/"); ?>">First</a></li>
											<?php
												for ($i=$page1;$i<$page2+1;$i++) {
													echo "<li class=\"paginate_button";
													if ($i==$page) { echo " active"; }
													echo "\" aria-controls=\"datatable\" tabindex=\"0\"><a href=\"".site_url("jamaah/booking/".$i)."\">$i</a></li>";
												}
											?>
											<li class="paginate_button next" aria-controls="datatable" tabindex="0" id="datatable_next"><a href="<?php echo site_url("jamaah/booking/".$jmlpage); ?>">Last</a></li>
										</ul>
									</div>
								<?php } ?>                 		
								</div>
...
<?php } elseif($site_form=="formbooking") { ?>
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10"><input type="text" name="nama" class="form-control" placeholder="Nama Kontak"></div>
                        </div>
                        <div class="form-group">
							<label class="col-sm-2 control-label">No Telepon</label>
                            <div class="col-sm-10"><input type="text" name="telepon" class="form-control" placeholder="No Telepon"></div>
                        </div>
                        <div class="form-group">
							<label class="col-sm-2 control-label">Email</label>
                            <div class="col-sm-10"><input type="email" name="email" class="form-control" placeholder="Email"></div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-4 col-sm-offset-2">
                                ...
                                <button name="tombol" class="btn btn-primary" value="simpan" type="submit">Booking</button> 
                            </div>
                        </div>						
						</form>
						</div>
