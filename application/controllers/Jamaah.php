...
class Jamaah extends CI_Controller {
	...
	public function booking($page="1",$bookingid="0",$profileid="0") {
		$this->general->session_check();
		...
		if ($tombol!="") {
			...
			return redirect(site_url('jamaah/booking/'));
		}
		$page_view = "jamaah_booking";
		//tambah peserta jamaah by kode booking
		if ($page == "jamaah" && $bookingid == "new") {
		...
		//ubah peserta
		else if ($page == "jamaah" && $bookingid == "ubah") {
			$page_view = "jamaah_profile";
			
			$data['site_form'] 	= "jamaahubah";
			$data['profileid'] 	= $profileid;
